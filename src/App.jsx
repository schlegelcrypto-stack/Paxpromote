            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "1rem", marginBottom: "2rem" }}>
              {TIERS.map(tier => (
                <div key={tier.id} onClick={() => setSelectedTier(tier)} style={{
                  background: selectedTier?.id === tier.id ? C.cyanDim : tier.featured ? "rgba(0,224,255,0.03)" : "rgba(255,255,255,0.02)",
                  ...
                  {tier.featured && (
                    <div style={{
                      ...
                      background: `linear-gradient(135deg, ${C.cyan}, #0090cc)`,
                      color: "#050505", fontFamily: "'Inter', sans-serif",
                      fontWeight: 800, letterSpacing: "0.12em", fontSize: "0.55rem",
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "1rem" }}>
                    <div>
                      ...
                      <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.78rem", color: C.text3, marginTop: 2 }}>{tier.tagline}</div>
                    </div>
                    <div style={{ textAlign: "right", flexShrink: 0 }}>
                    ...
                    {tier.features.map(f => (
                      <div key={f} style={{ display: "flex", gap: "0.6rem", alignItems: "center" }}>
                        <div style={{ width: 14, height: 14, borderRadius: 2, background: selectedTier?.id === tier.id ? C.cyan : tier.color, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                          <span style={{ fontSize: "0.55rem", color: "#050505", fontWeight: 900 }}>✓</span>
                        </div>
                        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.8rem", color: C.text2 }}>{f}</span>
                      </div>
                    ))}
                  </div>
                  {selectedTier?.id === tier.id && (
                    <div style={{ marginTop: "1rem", fontFamily: "'Space Mono', monospace", fontSize: "0.65rem", color: C.cyan, letterSpacing: "0.1em" }}>✓ SELECTED</div>
                  )}
                </div>
              ))}
            </div>
...
function HomeTiersStrip({ setView }) {
  const isMobile = useIsMobile();
  return (
    <section style={{ background: "#050505", padding: isMobile ? "3rem 1.2rem 4rem" : "4rem 2rem 5rem", borderTop: `1px solid ${C.border}` }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: isMobile ? "2rem" : "3rem" }}>
          <div style={{ fontFamily: "'Space Mono', monospace", letterSpacing: "0.2em", color: C.cyan, fontSize: "0.65rem", marginBottom: "0.75rem", textTransform: "uppercase" }}>All payments in PAX token</div>
          <h2 style={{ fontFamily: "'Inter', sans-serif", fontWeight: 800, fontSize: "clamp(2rem, 5vw, 3rem)", letterSpacing: "-0.04em", margin: 0 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(4, 1fr)", gap: isMobile ? "0.75rem" : "1rem" }}>
          {TIERS.map(tier => (
            <div key={tier.id} style={{
              background: tier.featured ? `linear-gradient(135deg, rgba(0,224,255,0.07), rgba(5,5,5,0.95))` : "rgba(255,255,255,0.02)",
              border: `1px solid ${tier.featured ? C.cyan : C.border}`,
              ...
              <div>
                ...
                <div style={{ fontFamily: "'Inter', sans-serif", fontWeight: 800, fontSize: isMobile ? "0.9rem" : "1rem", color: tier.color, letterSpacing: "-0.02em" }}>{tier.name}</div>
                <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.75rem", color: C.text3, marginTop: 2 }}>{tier.tagline}</div>
              </div>
              <div>
                <span style={{ fontFamily: "'Space Mono', monospace", fontSize: isMobile ? "1.3rem" : "1.6rem", fontWeight: 700, color: C.text, letterSpacing: "-0.04em" }}>{tier.price}</span>
                <span style={{ color: C.cyan, fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: "0.75rem", marginLeft: "0.3rem" }}>PAX</span>
              </div>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: "center", justifyContent: "space-between", gap: "1.5rem" }}>
        ...
        <div style={{ textAlign: isMobile ? "center" : "left" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: isMobile ? "center" : "flex-start", gap: 0, marginBottom: "0.4rem" }}>
            <span style={{ fontFamily: "'Inter', sans-serif", fontWeight: 800, fontSize: "1.1rem", letterSpacing: "-0.03em", color: C.text }}>PAX</span>
            <span style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, fontSize: "1.1rem", letterSpacing: "-0.02em", color: C.text }}>promote</span>
          </div>
          <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.72rem", color: C.text3 }}>
