...
var W3mModal = class W3mModal2 extends LitElement {
  ...
  async handleClose() {
    if (this.isSiweEnabled) {
      const { SIWEController } = await import("./exports-IU42QDMD.js");
  ...
  onAddKeyboardListener() {
    ...
    const card = (_a3 = this.shadowRoot) == null ? void 0 : _a3.querySelector("wui-card");
  ...
  async onNewAddress(caipAddress) {
    ...
    if (this.isSiweEnabled) {
      ...
      if (session && previousAddress && newAddress && previousAddress !== newAddress) {
        if ((_a3 = SIWEController.state._client) == null ? void 0 : _a3.options.signOutOnAccountChange) {
...
@lit/reactive-element/development/decorators/query-assigned-nodes.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZHUPKXCQ.js.map
