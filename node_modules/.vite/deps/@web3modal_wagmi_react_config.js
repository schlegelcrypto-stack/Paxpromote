...
import {
  call_exports,
  mini_exports
} from "./chunk-PZVG6HSB.js";
import "./chunk-ZAKRDXB4.js";
import {
...
import {
  ...
  createConnector,
  getTransport
} from "./chunk-DYHHE2HG.js";
import "./chunk-KNKGUYHA.js";
import {
  W3mFrameProvider
} from "./chunk-M2PFANEY.js";
import "./chunk-JHMYOU3E.js";
import "./chunk-ZHUPKXCQ.js";
import "./chunk-NPY75PGV.js";
import "./chunk-MZXFFUKN.js";
import "./chunk-OR67L7UC.js";
import "./chunk-DOQHPYZH.js";
import "./chunk-6S4FW6H3.js";
  ...
  return createConnector2((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-DOANOZMX.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-L6R6SN2Y.js");
  ...
  return createConnector2((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-AXVG3OTA.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-3Z27THP6.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-3E4HRZ3J.js");
